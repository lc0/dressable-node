...
~~~sh
git clone git@github.com:nko3/brainscode.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-brainscode --password ndDp8gWRbeAHEYoj
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/brainscode" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280957
